...
public class QueuePublisherService {
    ...
    public void sendToOcr(OcrRequestEvent evt) {
        rabbitTemplate.convertAndSend(exchange, ocrKey, evt);
    }

    public void sendOcrResult(OcrResultEvent evt) {
        rabbitTemplate.convertAndSend(exchange, resultKey, evt);
    }
}
